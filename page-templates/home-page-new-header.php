		...
		<div class="intro__item intro__item--1">
			<div class="intro__item-inner">
				...
				<div class="intro__item-img">
					<img src="/wp-content/themes/infusemedia/frontend/images/content/icon-logo-1.svg" alt="Entrepreneur 360">
				</div>
			</div>
		</div>
			...
			<div class="intro__item-inner">
				<div class="intro__item-left">
					<div class="intro__item-all">
						<?php the_field("intro_last_item_text"); ?>
					</div>
					...
					<div class="insights__slide">
						<div class="insights__elements-list">
                            <?php foreach ($slide as $insight):?>
                                <div class="insights__element-item <?php echo (get_field('size', $insight->ID) == 2) ? 'insights__element-item_big' : '' ?>">
                                    <!-- (insight) -->
